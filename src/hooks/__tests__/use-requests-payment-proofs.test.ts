...
describe("attachPaymentProof", () => {
  it("envía archivo e ids de asignación al endpoint canónico", async () => {
    ...
    expect(formData.get("request_allocation_ids")).toBe(JSON.stringify(["allocation-1", "allocation-2"]));
