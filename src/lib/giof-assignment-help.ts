...
export const GIOF_STAGE_GUIDES: readonly GiofStageGuide[] = [
  ...
  },
  {
    ...
    assignable: "Pendiente de pago, o Pago registrado con Falta constancia o Falta referencia.",
  ...
  },
  {
    ...
    assignable: "En preparación, En revisión, En validación u Observada. Una Observada con Faltan documentos mantiene seguimiento asignable.",
